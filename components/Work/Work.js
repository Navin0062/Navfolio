    ...
    () => [
      {
        ...
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.NSS}
          />
        ),
      },
      {
        ...
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.JOB_PORTAL}
          />
        ),
      },
        ...
        <div className="flex flex-col work-wrapper">
          <div className="flex flex-col">
            ...
            <h2 className="text-[1.65rem] font-medium md:max-w-lg w-full mt-2 staggered-reveal">
              Here&apos;s a summary of my professional experience and where I&apos;ve contributed my skills.{" "}
